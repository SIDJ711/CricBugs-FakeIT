...
const players: Player[] = [
  ...
  },
  {
    id: "steve-smith",
    name: "Steve Smith",
    nickname: "Fidget Master",
    country: "Australia",
    emoji: "🇦🇺",
    role: "Batsman / OCD Specialist",
    image: "🦘",
    consistency: 82,
    appealRate: 67,
    batSwingMiss: 8,
  ...
  },
  {
    id: "babar-azam",
    name: "Babar Azam",
    nickname: "Cover Drive Collector",
    country: "Pakistan",
    emoji: "🇵🇰",
    role: "Batsman / Aesthetic Specialist",
    image: "✨",
    consistency: 75,
    appealRate: 45,
    batSwingMiss: 5,
